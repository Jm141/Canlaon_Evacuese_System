...
abstract class Controller {
    ...
    /**
     * Get barangay filter for current user
     * Main admin can see all barangays, others see only their assigned barangay
     */
    protected function getBarangayFilter() {
        if (isMainAdmin()) {
            return null; // null means no filter (show all)
        }
        return $this->getUserBarangayId();
    }
