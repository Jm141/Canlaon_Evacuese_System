    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="residents.php?action=view&id=<?= $resident['id'] ?>" class="btn btn-secondary btn-sm">
            ...
            <div class="card-body">
                <form method="POST" action="" id="residentForm">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" 
                                   value="<?= htmlspecialchars($resident['date_of_birth']) ?>" required>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="nationality" name="nationality" 
                                   value="<?= htmlspecialchars($resident['nationality'] ?? 'Filipino') ?>">
                        </div>
                        
                        <div class="col-md-4 mb-3">
                            <label for="religion" class="form-label">Religion</label>
                            <input type="text" class="form-control" id="religion" name="religion" 
                                   value="<?= htmlspecialchars($resident['religion'] ?? '') ?>">
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" id="educational_attainment" name="educational_attainment">
                                ...
                                <option value="High School" <?= ($resident['educational_attainment'] ?? '') === 'High School' ? 'selected' : '' ?>>High School</option>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control" id="address" name="address" rows="3" 
                                      placeholder="Enter complete address including street, barangay, city/municipality" required><?= htmlspecialchars($resident['address']) ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="collection_point" name="collection_point" 
                                   value="<?= htmlspecialchars($resident['collection_point'] ?? '') ?>" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="assigned_evacuation_center" name="assigned_evacuation_center" 
                                   value="<?= htmlspecialchars($resident['assigned_evacuation_center'] ?? '') ?>" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="evacuation_vehicle" name="evacuation_vehicle" 
                                   value="<?= htmlspecialchars($resident['evacuation_vehicle'] ?? '') ?>" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="vehicle_driver" name="vehicle_driver" 
                                   value="<?= htmlspecialchars($resident['vehicle_driver'] ?? '') ?>" 
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="emergency_contact_relationship" name="emergency_contact_relationship" 
                                   value="<?= htmlspecialchars($resident['emergency_contact_relationship'] ?? '') ?>"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="has_special_needs" name="has_special_needs" value="1" 
                                       <?= ($resident['has_special_needs'] ?? 0) ? 'checked' : '' ?>>
                        ...
                        <div class="col-md-12 mb-3" id="special_needs_description_group" style="display: <?= ($resident['has_special_needs'] ?? 0) ? 'block' : 'none' ?>;">
                            ...
                            <textarea class="form-control" id="special_needs_description" name="special_needs_description" rows="3" 
                                      placeholder="Describe the special needs or medical conditions..."><?= htmlspecialchars($resident['special_needs_description'] ?? '') ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                <a href="residents.php?action=view&id=<?= $resident['id'] ?>" class="btn btn-secondary">
